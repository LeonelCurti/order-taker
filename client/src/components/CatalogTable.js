...
const CatalogTable = (props) => {
  ...
  const { products, addProductOn, updateOrder, currentOrder } = props;
  ...
  return (
    <div className={classes.root}>
      ...
      <EnhancedTableToolbar title="Catalog" searchTextUpdate={onChange} />
        {/* <Divider /> */}
...
export default connect(mapStateToProps, orderActions)(CatalogTable);
